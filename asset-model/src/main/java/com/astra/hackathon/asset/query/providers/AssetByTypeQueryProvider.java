...
public class AssetByTypeQueryProvider implements QueryProvider {

	private static final Logger logger = LoggerFactory.getLogger(AssetByTypeQueryProvider.class);

	private static final String TABLE_NAME = "asset_by_type";
