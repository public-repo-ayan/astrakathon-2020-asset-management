...
public class AssetByBucketQueryProvider implements QueryProvider {

	private static final Logger logger = LoggerFactory.getLogger(AssetByBucketQueryProvider.class);

	private static final String TABLE_NAME = "asset_by_bucket";
