...
public class AssetByStatusQueryProvider implements QueryProvider {

	private static final Logger logger = LoggerFactory.getLogger(AssetByStatusQueryProvider.class);

	private static final String TABLE_NAME = "asset_by_status";
